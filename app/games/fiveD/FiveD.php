...
class FiveD extends GamePlayFunction5D{ 
    ...
    public static function group120(Array $drawNumber, Array $selection) : Bool { // group 120
    ...
    public static function group60(Array $drawNumber, Array $selection) : bool { // group 60
    ...
    public static function group30(Array $drawNumber, Array $selection) : bool { // group 30
    ...
    public static function group20(Array $drawNumber, Array $selection) : bool { // group 20
    ...
    public static function group10(Array $drawNumber, Array $selection): bool { // group 10
        $val = array_count_values($drawNumber);
    ...
    public static function group5(Array $drawNumber, Array $selection): bool { // group 5
        $val = array_count_values($drawNumber);
    ...
    public static function group24(Array $drawNumber, Array $selection): mixed { // group 24
        sort($drawNumber); sort($selection);
        return Utils::findPattern([1,1,1,1], $drawNumber, 0, 5) && 
        $drawNumber == $selection ? true : false; #-> fn([1,1,2,2,3],[[1,2,3,4]],[1,1,1,1],5) = true
    }

    public static function group12(Array $drawNumber, Array $selection): mixed { // group 12
        $val = array_count_values($drawNumber); unset($selection[1][max($val)]);
    ...
    public static function group6(Array $drawNumber, Array $selection): mixed { // group 6
        $val = array_count_values($drawNumber);
        return Utils::findPattern([2,1,1], $drawNumber, 0, 5) && 
        in_array(array_search(max($val), $val), $selection[0]) && 
