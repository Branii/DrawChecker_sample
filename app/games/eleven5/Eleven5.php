...
class Eleven5 extends GamePlayFunction {
   ...
   public static function getGamePlayMethod () : Array {
    ...
    public static function f3straightJoint(Array $selection, Array $drawNumbers) : Bool {
      ...
      public static function f3groupJoint(Array $selection, Array $drawNumbers) : Bool {
        $winningNumbers = array_slice($drawNumbers, 0, 3);
        return count(array_intersect($selection,$winningNumbers)) ==  3;
      } // fn -> ['03','04','02'],['04','03','02','04','05'] = true
      
      public static function f3straightManual(Array $selection, Array $drawNumbers) {
        $winningNumbers = array_slice($drawNumbers, 0, 3);sort($winningNumbers);
       ...
       public static function f3groupManual(Array $selection, Array $drawNumbers) {
        $winningNumbers = array_slice($drawNumbers, 0, 3);sort($winningNumbers);
        foreach($selection as $item){
      ...
      public static function f2straightJoint(Array $selection, Array $drawNumbers) : Bool {
        $winningNumbers = array_slice($drawNumbers, 0, 2);
        return in_array($winningNumbers[0],$selection[0]) &&
        in_array($winningNumbers[1],$selection[1]);
      } // fn -> [['01','02'],['03','05']],['01','03','08','04','05'] = true
      
      public static function f2groupJoint(Array $selection, Array $drawNumbers) : Bool {
        $winningNumbers = array_slice($drawNumbers, 0, 2);
        return count(array_intersect($selection,$winningNumbers)) ==  2;
      } // fn -> ['03','04','02'],['04','03','02','04','05'] = true
      
      public static function f2straightManual(Array $selection, Array $drawNumbers) {
        $winningNumbers = array_slice($drawNumbers, 0, 2);sort($winningNumbers);
        foreach($selection as $item){
          $newArr = str_split($item[0],2);
          return implode(',', $newArr) === implode(',', $winningNumbers);
        }
       ...
       public static function f2groupManual(Array $selection, Array $drawNumbers) {
        $winningNumbers = array_slice($drawNumbers, 0, 2);sort($winningNumbers);
        foreach($selection as $item){
          $newArr = str_split($item[0],2); sort($newArr);
          return $newArr == $winningNumbers;
      ...
      public static function anyPlace(Array $selection, Array $drawNumbers) : Bool {
        $winningNumbers = array_slice($drawNumbers, 0, 3);
       ...
       public static function fixedPlace(Array $selection, Array $drawNumbers) : Bool {
        $winningNumbers = array_slice($drawNumbers, 0, 3);
        ...
        public static function pickJoint1x1(Array $selection, Array $drawNumbers) : Bool {
          $winningNumbers = array_slice($drawNumbers, 0, 5);
          return count(array_intersect($selection,$winningNumbers)) == 1;
        } // fn -> ['03','04','02'],['04','03','02','04','05'] = true
    
        public static function pickJoint2x2(Array $selection, Array $drawNumbers) : Bool {
          $winningNumbers = array_slice($drawNumbers, 0, 5);
          return count(array_intersect($selection,$winningNumbers)) == 2;
        } // fn -> ['03','04'],['04','03','02','04','05'] = true
    
        public static function pickJoint3x3(Array $selection, Array $drawNumbers) : Bool {
          $winningNumbers = array_slice($drawNumbers, 0, 5);
          return count(array_intersect($selection,$winningNumbers)) == 3;
        } // fn -> ['03','04','02'],['04','03','02','04','05'] = true
    
        public static function pickJoint4x4(Array $selection, Array $drawNumbers) : Bool {
          $winningNumbers = array_slice($drawNumbers, 0, 5);
          return count(array_intersect($selection,$winningNumbers)) == 4;
        } // fn -> ['03','04','02','01'],['04','03','02','04','05'] = true
    
        public static function pickJoint5x5(Array $selection, Array $drawNumbers) : Bool {
          $winningNumbers = array_slice($drawNumbers, 0, 5);
          return count(array_intersect($selection,$winningNumbers)) == 5;
        } // fn -> ['03','04','02','07','08'],['04','03','02','08','07'] = true
    
        public static function pickJoint5x6(Array $selection, Array $drawNumbers) : Bool {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
            return count(array_intersect($selection,$winningNumbers)) == 5;
        } // fn -> ['03','04','02','07','08','01'],['04','03','02','08','07'] = true
    
        public static function pickJoint5x7(Array $selection, Array $drawNumbers) : Bool {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
            return count(array_intersect($selection,$winningNumbers)) == 5;
        } // fn -> ['03','04','02','07','08','01','06'],['04','03','02','08','07'] = true
    
        public static function pickJoint5x8(Array $selection, Array $drawNumbers) : Bool {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
            return count(array_intersect($selection,$winningNumbers)) == 5;
        ...
        public static function pickManual1x1(Array $selection, Array $drawNumbers) : Bool {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
        ...
        public static function pickManual2x2(Array $selection, Array $drawNumbers) : Bool {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
            foreach($selection as $item){
               $newArr = str_split($item[0],2);
        ...
        public static function pickManual3x3(Array $selection, Array $drawNumbers) : Bool {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
            foreach($selection as $item){
               $newArr = str_split($item[0],2);
        ...
        public static function pickManual4x4(Array $selection, Array $drawNumbers) : Bool {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
            foreach($selection as $item){
               $newArr = str_split($item[0],2);
        ...
        public static function pickManual5x5(Array $selection, Array $drawNumbers) : Bool {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
            foreach($selection as $item){
               $newArr = str_split($item[0],2);
        ...
        public static function pickManual5x6(Array $selection, Array $drawNumbers) : Bool {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
            foreach($selection as $item){
               $newArr = str_split($item[0],2);
               return count(array_intersect($newArr,$winningNumbers)) == 5;
        ...
        public static function pickManual5x7(Array $selection, Array $drawNumbers) : Bool {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
            foreach($selection as $item){
               $newArr = str_split($item[0],2);
               return count(array_intersect($newArr,$winningNumbers)) == 5;
        ...
        public static function pickManual5x8(Array $selection, Array $drawNumbers) : Bool {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
            foreach($selection as $item){
               $newArr = str_split($item[0],2);
               return count(array_intersect($newArr,$winningNumbers)) == 5;
        ...
        public static function fixedDigit2x2(Array $selection, Array $drawNumbers)  {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
        ...
        public static function fixedDigit3x3(Array $selection, Array $drawNumbers)  {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
        ...
        public static function fixedDigit4x4(Array $selection, Array $drawNumbers)  {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
        ...
        public static function fixedDigit5x5(Array $selection, Array $drawNumbers)  {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
            $arrCombine = array_merge($selection[0],$selection[1]);
            return count(array_intersect($winningNumbers,$arrCombine)) == 5;
        } // fn -> [['03','04','01','02'],['02','08','07']],['04','03','02','08','07'] = true
    
        public static function fixedDigit5x6(Array $selection, Array $drawNumbers)  {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
            $arrCombine = array_merge($selection[0],$selection[1]);
            return count(array_intersect($winningNumbers,$arrCombine)) == 5;
        } // fn -> [['03','04','01','02'],['02','08','07','06']],['04','03','02','08','07'] = true
    
        public static function fixedDigit5x7(Array $selection, Array $drawNumbers)  {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
            $arrCombine = array_merge($selection[0],$selection[1]);
            return count(array_intersect($winningNumbers,$arrCombine)) == 5;
        } // fn -> [['03','04','01','02'],['02','08','07','06','09']],['04','03','02','08','07'] = true
    
        public static function fixedDigit5x8(Array $selection, Array $drawNumbers)  {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
            $arrCombine = array_merge($selection[0],$selection[1]);
            return count(array_intersect($winningNumbers,$arrCombine)) == 5;
        ...
        public static function funOddEven(Array $selection, Array $drawNumbers) : Bool {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
        ...
        public static function funTheMiddleNo(Array $selection, Array $drawNumbers) : Bool {
            $winningNumbers = array_slice($drawNumbers, 0, 5);
       ...
       public static function twoSidesRapido(String $jsonObject, Array $drawNumbers, String $flag) {
        $winningNumbers = array_slice($drawNumbers, 0, 5);
          ...
          switch ($flag) {
              case "sum":
                  return [
                      ...
                      'Odd' => $sum % 2 != 0,
                      'Even' => $sum % 2 == 0,
                      'Dragon' => intval($drawNumbers[0]) > intval($drawNumbers[4]),
                      'Tiger'  => intval($drawNumbers[0]) < intval($drawNumbers[4]),
       ...
       public static function pick(string $jsonString, Array $drawNumbers) {
        $jsonArray = json_decode($jsonString, true);
        $selection = explode(",", $jsonArray['selection']);
    
        switch ($pick = $jsonArray['pick']) {
            case 'first2group':
                return count(array_intersect($selection, array_slice($drawNumbers, 0, 2))) == 2;
            case 'first3group':
                return count(array_intersect($selection, array_slice($drawNumbers, 0, 3))) == 3;
            default:
                $winningNumbers = array_slice($drawNumbers, 0, 5);
       ...
       public static function straightFirst2Group (Array $selection, Array $drawNumbers){
        $winningNumbers = array_slice($drawNumbers, 0, 2);
        return in_array($winningNumbers[0],$selection[0]) &&
        in_array($winningNumbers[1],$selection[1]);
       } // fn -> [['02','01'],['03','04']],['01','03','08','04','05'] = true
    
       public static function straightFirst3Group (Array $selection, Array $drawNumbers){
        $winningNumbers = array_slice($drawNumbers, 0, 3);
        return in_array($winningNumbers[0],$selection[0]) &&
        in_array($winningNumbers[1],$selection[1]) && in_array($winningNumbers[2],$selection[2]);
       } // fn -> [['02','01'],['03','04'],['05','07']],['01','03','08','04','05'] = true
